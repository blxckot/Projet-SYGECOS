...
// Configuration de sécurité pour les tentatives de connexion
define('MAX_LOGIN_ATTEMPTS', 3); // Nombre maximum de tentatives avant blocage
define('LOCKOUT_TIME', 10);      // Durée du blocage en secondes (10 secondes)
