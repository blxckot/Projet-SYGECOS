    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <div class="nav-items-wrapper">
                <div class="nav-item">
                    <a href="dashboard_responsable.php" class="nav-link">
                        <div class="nav-icon">
        ...
        <div class="nav-section">
            ...
            <div class="nav-items-wrapper">
                <div class="nav-item">
                    <a href="info_perso_scolarité.php" class="nav-link">
                        <div class="nav-icon">
        ...
        <div class="nav-section">
            <div class="nav-section-title">Gestion administrative</div>
            <div class="nav-items-wrapper">
                <div class="nav-item">
                    <a href="gestion_filiere.php" class="nav-link">
                        <div class="nav-icon">
                            <i class="fas fa-user-circle"></i>
                        </div>
                ...
                <div class="nav-item">
                    <a href="gestion_niveau.php" class="nav-link">
                        <div class="nav-icon">
                            <i class="fas fa-graduation-cap"></i>
                        </div>
                        <span class="nav-text">Niveau</span>
                    </a>
                </div>
                <div class="nav-item">
                    <a href="gestion_details_scolarité.php" class="nav-link">
                        <div class="nav-icon">
                            <i class="fas fa-graduation-cap"></i>
                        </div>
                        <span class="nav-text">Détails scolarité</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="nav-section">
            ...
            <div class="nav-items-wrapper">
                ...
                <div class="nav-item">
                    <a href="compte_etudiant.php" class="nav-link">
                        <div class="nav-icon">
                            <i class="fas fa-user-graduate"></i>
                        </div>
                        <span class="nav-text">Compte étudiant</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="nav-section">
            ...
            <div class="nav-items-wrapper">
                <div class="nav-item">
                    <a href="messagerie_scolarite.php" class="nav-link">
                        <div class="nav-icon">
...
<style>
    /* === VARIABLES CSS (identiques à sidebar.php pour la cohérence) === */
    :root {
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* === SIDEBAR (adapté pour les sections dépliables) === */
    .sidebar {
        position: fixed;
        top: 0;
        left: 0;
    ...
    /* === TOPBAR (ajouté pour la cohérence même si non directement dans la sidebar) === */
    .topbar {
    ...
    /* === ÉLÉMENTS SPÉCIFIQUES DE LA PAGE (conservés pour l'aspect visuel) === */
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initial collapse/expand for all sections based on active status on load
        // This ensures sections containing the active link are open when the page loads
        navSectionTitles.forEach(title => {
